...
typedef enum
{
	/*lint --e{30,113} Inconsistent enum declaration*/
#if !defined(_RUNTIME_) || defined(_REPLACE_CONST)
#if !defined(ERR_OK) && (defined(__cplusplus) || defined(_AR_I386_AUTOMATION_STUDIO_))
	ERR_OK = 0, /* No error */
#endif
#ifndef _AR_I386_AUTOMATION_STUDIO_
	ERR_RTK_OK = ERR_OK,
#endif
#endif
